...
<!--	  <input type="password" class="form-control mg-t-10" name="jiPwdConf" placeholder="비밀번호를 한번 더 입력해주세요.">  -->
        ...
        <div class="form-group">
          ...
          <div class="row row-xs">
            <div class="col-sm-4">
              <input type="text" class="form-control" placeholder="YYYY" name="jiBirth1">
            </div><!-- col-4 -->
            <div class="col-sm-4 mg-t-20 mg-sm-t-0">
              <input type="text" class="form-control" placeholder="MM" name="jiBirth2">
            </div><!-- col-4 -->
            <div class="col-sm-4 mg-t-20 mg-sm-t-0">
				<input type="text" class="form-control" placeholder="DD" name="jiBirth3">
            </div><!-- col-4 -->
          </div><!-- row -->
        </div><!-- form-group -->
		<div class="form-group">
          ...
          <div class="row row-xs">
            <div class="col-sm-4">
              <input type="text" class="form-control" placeholder="010" name="jiMobile1">
            </div><!-- col-4 -->
            <div class="col-sm-4 mg-t-20 mg-sm-t-0">
              <input type="text" class="form-control" placeholder="1234" name="jiMobile2">
            </div><!-- col-4 -->
            <div class="col-sm-4 mg-t-20 mg-sm-t-0">
				<input type="text" class="form-control" placeholder="5678" name="jiMobile3">
            </div><!-- col-4 -->
          </div><!-- row -->
        </div><!-- form-group -->
		<div class="form-group">
